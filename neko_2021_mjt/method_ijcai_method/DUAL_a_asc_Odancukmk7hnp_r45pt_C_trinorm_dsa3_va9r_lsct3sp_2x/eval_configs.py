...
from neko_2021_mjt.dss_presets.dual_no_lsct_32 import get_eval_dssenjp,get_eval_dss_kr;
def dan_mjst_eval_cfg(
    ...
    if(log_path):
        ...
        epath=None;
    te_meta_path_chsjap, te_meta_path_mjst, mjst_eval_ds, chs_eval_ds=get_eval_dssenjp(dsroot,25,30);
    task_dict = {}
    ...
    te_meta_path_kr, _, _, kr_eval_ds=get_eval_dss_kr(dsroot,25,30);
    task_dict = arm_base_task_default2(task_dict, "base_chs_", osdanmk7_eval_routine_cfg, 30,
                                         te_meta_path_kr, kr_eval_ds,
