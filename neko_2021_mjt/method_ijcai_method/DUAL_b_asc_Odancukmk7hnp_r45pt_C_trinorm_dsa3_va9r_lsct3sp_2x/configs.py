...
from neko_2021_mjt.dss_presets.dual_lsct32 import get_dssm,get_teds;
...
def model_mod_cfg(tr_meta_path_chs,tr_meta_path_mjst,maxT_mjst,maxT_chs):
    ...
    feat_ch=512;
    mods={};
    mods=arm_lsctsp_module_set_r45pt_trinorm_orig_dsa3hGTAnp_va9_mk7(mods,"base_mjst_",maxT_mjst,capacity,feat_ch,tr_meta_path_mjst,wemb=0,expf=1.5);
    # mods=arm_lsctsp_module_set_r45pt_trinorm_orig_dsa3hGTAnp_va9_mk7(mods,"base_chs_",maxT_chs,capacity,feat_ch,tr_meta_path_chs,wemb=0);
    return mods;
...
def dan_single_model_train_cfg(save_root,dsroot,
    ...
    tr_meta_path_chsjap,te_meta_path_chsjap,tr_meta_path_mjst,te_meta_path_mjst,train_joint_ds=get_dssm(dsroot,maxT_mjst,maxT_chs,bsize,pfac=2);
