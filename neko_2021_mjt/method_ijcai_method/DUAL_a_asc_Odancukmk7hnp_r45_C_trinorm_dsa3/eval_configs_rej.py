...
def dan_mjst_eval_cfg(
    ...
    te_meta_path_chsjapo, te_meta_path_mjst, mjst_eval_ds, chs_eval_ds=get_eval_dssosr(dsroot,25,30);
    te_meta_path_chsjapg, te_meta_path_mjstg, mjst_eval_dsg, chs_eval_dsg=get_eval_dssgosr(dsroot,25,30);
    te_meta_path_chsjapostr, te_meta_path_mjstostr, mjst_eval_dsostr, chs_eval_dsg=get_eval_dssostr(dsroot,25,30);
    ...
    task_dict = arm_base_task_default2(task_dict, "base_chs_", osdanmk7_eval_routine_cfg, 30,
                                         te_meta_path_chsjapostr, chs_eval_dsg,
