...
def dan_mjst_eval_cfg(
    ...
    if(log_path):
        ...
        epath=None;
    te_meta_path_chsjap, te_meta_path_mjst, mjst_eval_ds, chs_eval_ds=get_bench_dss(dsroot,25,30);
    task_dict = {}
    task_dict = arm_base_task_default2(task_dict, "base_chs_", osdanmk7_eval_routine_cfg, 25,
